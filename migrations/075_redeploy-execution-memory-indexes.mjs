...
export const metadata = {
  ...
  description:
    'Re-deploy all indexes to fix missing execution_memories vector index and code_tasks pipeline index',
  createdAt: '2026-04-03',
};

export async function up(context) {
  console.log(
    '  Re-deploying all Firestore indexes (including execution_memories vector index)...'
  );
