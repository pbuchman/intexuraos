...
const phases = [
  ...
  },
  {
    ...
    commands: [
      ...
      { name: 'terraform-env-consumers', script: 'verify-terraform-env-consumers.mjs' },
      { name: 'ecosystem-coverage', script: 'verify-ecosystem-coverage.mjs' },
      { name: 'terraform-secret-mounts', script: 'verify-terraform-secret-mounts.mjs' },
