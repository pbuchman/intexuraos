...
const SERVICE_ENV_MAPPINGS = {
  ...
  'whatsapp-service': {
    ...
    INTEXURAOS_SPEECHMATICS_APP_API_KEY: process.env.INTEXURAOS_SPEECHMATICS_APP_API_KEY,
  ...
  'code-agent': {
    ...
    INTEXURAOS_LINEAR_CLIENT_ID: process.env.INTEXURAOS_LINEAR_CLIENT_ID,
    INTEXURAOS_LINEAR_CLIENT_SECRET: process.env.INTEXURAOS_LINEAR_CLIENT_SECRET,
    INTEXURAOS_LINEAR_WEBHOOK_SECRET: process.env.INTEXURAOS_LINEAR_WEBHOOK_SECRET,
  },
  'bookmarks-agent': {
