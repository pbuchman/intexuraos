...
CRITICAL_VARS="INTEXURAOS_GCP_PROJECT_ID INTEXURAOS_INTERNAL_AUTH_TOKEN INTEXURAOS_AUTH_JWKS_URL INTEXURAOS_DASHSCOPE_APP_API_KEY INTEXURAOS_OPENAI_APP_API_KEY INTEXURAOS_SENTRY_DSN"
