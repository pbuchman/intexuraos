...
| `INTEXURAOS_ORCHESTRATOR_VALIDATION_MODELS` | `or:google/gemma-4-31b-it:free,gemini-2.5-flash` | Comma-separated ordered model list for completion verification and compliance validation |
