...
- All service URLs: `INTEXURAOS_USER_SERVICE_URL`, `INTEXURAOS_ACTIONS_AGENT_URL`, `INTEXURAOS_RESEARCH_AGENT_URL`, `INTEXURAOS_COMMANDS_AGENT_URL`, `INTEXURAOS_NOTES_AGENT_URL`, `INTEXURAOS_RETIRED_CHECKLIST_SERVICE_URL`, `INTEXURAOS_BOOKMARKS_AGENT_URL`, `INTEXURAOS_CODE_AGENT_URL`, `INTEXURAOS_APP_SETTINGS_SERVICE_URL`, `INTEXURAOS_CALENDAR_AGENT_URL`, `INTEXURAOS_WEB_AGENT_URL`, `INTEXURAOS_LINEAR_AGENT_URL`, `INTEXURAOS_RETIRED_CHAT_SERVICE_URL`, `INTEXURAOS_NOTION_SERVICE_URL`, `INTEXURAOS_WHATSAPP_SERVICE_URL`, `INTEXURAOS_IMAGE_SERVICE_URL`, `INTEXURAOS_MOBILE_NOTIFICATIONS_SERVICE_URL`, `INTEXURAOS_API_DOCS_HUB_URL`
...
- `INTEXURAOS_RETIRED_CHECKLIST_SERVICE_URL`, `INTEXURAOS_NOTES_AGENT_URL`, `INTEXURAOS_BOOKMARKS_AGENT_URL`
...
| `INTEXURAOS_RETIRED_CHECKLIST_SERVICE_URL`            | common_service_env_vars     | YES       |
