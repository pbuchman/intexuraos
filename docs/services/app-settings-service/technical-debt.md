...
2. **Remove startup dependency chain** — If decommissioned, update `ecosystem.config.cjs` `waitForService` entries for user-service, commands-agent, actions-agent, research-agent, and todos-agent
