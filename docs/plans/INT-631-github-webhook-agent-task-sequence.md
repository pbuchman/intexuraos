...
| 5   | 0    | [INT-636](https://linear.app/pbuchman/issue/INT-636/tier-0-add-retired-chat-service-internal-event-ingestion-endpoint)              | [tier-0] Add retired-chat-service internal event ingestion endpoint              | INT-635    | Create a retired-chat-service internal endpoint for idempotent system notifications from the GitHub webhook agent.                                                   |
...
### 5. [INT-636](https://linear.app/pbuchman/issue/INT-636/tier-0-add-retired-chat-service-internal-event-ingestion-endpoint) [tier-0] Add retired-chat-service internal event ingestion endpoint

- Purpose: Create a retired-chat-service internal endpoint for idempotent system notifications from the GitHub webhook agent.
- Files: `apps/retired-chat-service/src/routes/chatRoutes.ts`, `apps/retired-chat-service/src/routes/internalChatEventsRoute.ts`, `apps/retired-chat-service/src/routes/internalChatEventsRoute.test.ts`
...
- Purpose: Implement concrete executor tools wrapping sendTaskMessage/createTaskForPR and the new retired-chat-service internal event client.
- Files: `apps/code-agent/src/domain/githubWebhookAgent/notifier.ts`, `apps/code-agent/src/domain/githubWebhookAgent/tools.ts`, `apps/code-agent/src/infra/clients/retiredChatServiceClient.ts`, `apps/code-agent/src/domain/githubWebhookAgent/tools.test.ts`
