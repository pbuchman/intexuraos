...
```json
{
  ...
  "services": [
    ...
    { "name": "retired-checklist-service",                  "envSuffix": "RETIRED_CHECKLIST_SERVICE" },
    { "name": "bookmarks-agent",              "envSuffix": "BOOKMARKS_AGENT" },
    { "name": "calendar-agent",               "envSuffix": "CALENDAR_AGENT" },
    { "name": "retired-chat-service",                   "envSuffix": "RETIRED_CHAT_SERVICE" },
    ...
    { "name": "retired-scheduler-service",                   "envSuffix": "RETIRED_SCHEDULER_SERVICE" },
