...
| ------------------------------------------------------------------- | ------------------------------------------------ | ----------------- |
| `apps/bookmarks-agent/src/domain/usecases/summarizeBookmark.ts:114` | Bookmark summary ready (`📑 *Bookmark Summary*`) | **not important** |
...
| `apps/actions-agent/src/domain/usecases/executeCodeAction.ts:206`                           | Code action completion                             | **important** (long-running task finished)   |
...
| File                                                                                    | Call site                       | Recommendation                                                       |
| --------------------------------------------------------------------------------------- | ------------------------------- | -------------------------------------------------------------------- |
| `apps/mobile-notifications-service/src/infra/notification/whatsappDigestNotifier.ts:45` | Digest summary ready (INT-1417) | **not important** (digest is the low-priority channel by definition) |
