...
| `src/services/isolation/token-refresher.ts`                  | 7–13, 37, 114 | Single `/secrets/github-token` path, single installation, 30-min refresh loop                                | R-CHANGE  | Per-installation token files + timer.                                                                                                                                                     |
