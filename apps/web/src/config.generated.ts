...
export const WEB_SERVICE_URLS = [
  ...
  { envVar: 'INTEXURAOS_TODOS_AGENT_URL', apiPath: '/api/todos', proxyTarget: 'http://localhost:8123' },
  ...
  { envVar: 'INTEXURAOS_CHAT_AGENT_URL', apiPath: '/api/chat', proxyTarget: 'http://localhost:8129' },
  ...
  { envVar: 'INTEXURAOS_CRON_AGENT_URL', apiPath: '/api/cron-agent', proxyTarget: 'http://localhost:8130' },
