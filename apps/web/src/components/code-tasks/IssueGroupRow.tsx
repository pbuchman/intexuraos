              ...
              <div className="w-16 flex items-center justify-center">
                {isActioning ? (
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-md border border-slate-300 px-2 py-1 text-xs font-medium text-slate-600 transition-colors hover:border-slate-400 hover:text-slate-700 dark:border-slate-600 dark:text-slate-400 dark:hover:border-slate-500 dark:hover:text-slate-300"
                  >
                    <RotateCcw className="h-3 w-3" />
                    Retry
                  </button>
