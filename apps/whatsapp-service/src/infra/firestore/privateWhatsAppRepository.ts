...
async function countConversationContextMessages(
  ...
  try {
    ...
    return err({
      code: 'PERSISTENCE_ERROR',
      message: `Failed to count private WhatsApp conversation context messages: ${getErrorMessage(error, 'Unknown Firestore error')}`,
    });
  }
}
