 ...
 */
/* v8 ignore ts-type -- type narrowing for unknown error shapes */
...
export class SpeechmaticsTranscriptionAdapter implements SpeechTranscriptionPort {
  ...
  async getTranscript(
    ...
    try {
      ...
      /* v8 ignore test-infra -- fake transcription always returns language in results */
      ...
      let text = '';
      /* v8 ignore test-infra -- fake transcription always returns array results */
