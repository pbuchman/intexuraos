...
describe('WhatsAppCloudApiSender', () => {
  ...
  describe('sendCtaUrlMessage', () => {
    it('sends CTA URL message successfully', async () => {
      ...
      const result = await sender.sendCtaUrlMessage('+1234567890', 'Check this out', {
    ...
    it('removes + prefix from phone number', async () => {
      ...
      await sender.sendCtaUrlMessage('+447123456789', 'Test', {
        displayText: 'Click',
        url: 'https://example.com',
      });
    ...
    it('returns error on API failure', async () => {
      ...
      const result = await sender.sendCtaUrlMessage('+1234567890', 'Test', {
        displayText: 'Click',
        url: 'https://example.com',
      });
