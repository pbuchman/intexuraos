...
function buildOpenApiOptions(): FastifyDynamicSwaggerOptions {
  const servers = [
    {
      url: 'https://intexuraos-image-service-cj44trunra-lm.a.run.app',
      description: 'Cloud (Development)',
    },
    { url: 'http://localhost:8120', description: 'Local' },
  ];
  ...
  return {
    openapi: {
      ...
      info: {
        title: SERVICE_NAME,
        description: 'IntexuraOS Image Service - Thumbnail prompt generation and image creation',
