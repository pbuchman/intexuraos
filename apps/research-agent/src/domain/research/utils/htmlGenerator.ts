...
function renderGeneratedByInfo(
  ...
  const { name } = generatedBy;

  if (name !== undefined && name !== '') {
    return `<p class="meta">Generated by ${escapeHtml(name)} with IntexuraOS on ${formattedDate}</p>`;
  }
...
<body>
  <div class="container">
    <header>
      <img src="${staticAssetsUrl}/branding/logo-primary-dark.png" alt="IntexuraOS Research Agent">
    </header>
