...
describe('generateShareableHtml', () => {
  ...
  describe('generatedBy section', () => {
    ...
    it('ignores email when both name and email provided', () => {
      const html = generateShareableHtml({
        ...baseInput,
    ...
    it('falls back to date only when only email is provided', () => {
      const html = generateShareableHtml({
        ...baseInput,
    ...
    it('ignores email-only generatedBy for XSS safety', () => {
      const html = generateShareableHtml({
        ...baseInput,
