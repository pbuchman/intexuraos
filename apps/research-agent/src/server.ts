...
import { researchRoutes, researchExportRoutes, internalRoutes, openRouterRoutes } from './routes/index.js';
...
function buildOpenApiOptions(): FastifyDynamicSwaggerOptions {
  const servers = [
    ...
    { url: 'http://localhost:8116', description: 'Local' },
  ];
  ...
  return {
    openapi: {
      ...
      info: {
        title: SERVICE_NAME,
        description: 'IntexuraOS Research Agent Service - Multi-LLM research with synthesis',
...
export async function buildServer(): Promise<FastifyInstance> {
  ...
  await app.register(openRouterRoutes);
