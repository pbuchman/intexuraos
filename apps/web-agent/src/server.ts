...
const SERVICE_NAME = 'web-agent';
const SERVICE_VERSION = '1.0.0';

function buildOpenApiOptions(): FastifyDynamicSwaggerOptions {
  const servers = [
    {
      url: 'https://intexuraos-web-agent-cj44trunra-lm.a.run.app',
  ...
  return {
    openapi: {
      ...
      info: {
        title: SERVICE_NAME,
        description: 'IntexuraOS Web Agent - Link preview and Open Graph metadata extraction',
