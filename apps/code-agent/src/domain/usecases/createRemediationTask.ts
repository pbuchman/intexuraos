...
function buildRemediationPrompt(request: CreateRemediationTaskRequest): string {
  ...
  lines.push(
    ...
    '4. Before pushing, set `requiresReReview` via the internal API:',
    '   - `true`: substantive changes that alter behavior, architecture, or public API',
    '   - `false`: mechanical fixes (typos, formatting, straightforward bug fixes)',
    `5. Push changes to the PR branch`,
    '6. Output a summary of what was fixed and what was skipped',
    '',
    '### Constraints',
    '',
