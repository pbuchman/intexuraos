...
const EXPECTED_ROUTES: { method: 'GET' | 'POST' | 'PATCH' | 'DELETE'; url: string }[] = [
  ...
  { method: 'DELETE', url: '/code/tasks/:taskId' },
  { method: 'POST', url: '/code/tasks/:taskId/archive' },
  { method: 'POST', url: '/code/tasks/:taskId/implement' },
  { method: 'POST', url: '/code/cancel' },
  { method: 'POST', url: '/code/retry' },
  { method: 'GET', url: '/code/workers/status' },
  { method: 'POST', url: '/code/workers/refresh-status' },
];
