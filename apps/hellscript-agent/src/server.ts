...
function buildOpenApiOptions(): FastifyDynamicSwaggerOptions {
  const servers = [
    {
      url: 'https://intexuraos-hellscript-agent-cj44trunra-lm.a.run.app',
      description: 'Cloud (Development)',
    },
    { url: 'http://localhost:8131', description: 'Local' },
  ];
  ...
  return {
    openapi: {
      ...
      info: {
        title: SERVICE_NAME,
        description: 'IntexuraOS Hellscript Agent - Voice-to-draft writing assistant',
      ...
      tags: [
        ...
        { name: 'hellscript', description: 'Hellscript buffer operations' },
      ],
    },
  };
}
