...
function buildOpenApiOptions(): FastifyDynamicSwaggerOptions {
  const servers = [
    {
      url: 'https://intexuraos-calendar-agent-cj44trunra-lm.a.run.app',
      description: 'Cloud (Development)',
    },
    { url: 'http://localhost:8125', description: 'Local' },
  ];
  ...
  return {
    openapi: {
      ...
      info: {
        title: SERVICE_NAME,
        description: 'IntexuraOS Calendar Agent - Google Calendar operations',
